...
function updatePositions() {
  ...
  //Elias Flyttade alla variabler utanför for loopen så den inte loopar onödigt många ggr
...
function createBGPizza() {
  ...
  //Elias behöver jag verkligen animera 200 pizzor när jag ändå bara kan se
  //en handfull pizzor
